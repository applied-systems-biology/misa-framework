...
import org.hkijena.misa_imagej.extension.datasources.MISAImageStackDataSource;

public class MISAImageStackCache extends MISACache {

    private MISAImageStackDataSource nativeDataSource;


    public MISAImageStackCache(MISASample sample, MISAFilesystemEntry filesystemEntry) {
        super(sample, filesystemEntry);
        nativeDataSource = new MISAImageStackDataSource(this);
