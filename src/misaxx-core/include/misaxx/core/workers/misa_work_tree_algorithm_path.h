...
namespace misaxx {
    ...
    public:
        ...
        explicit misa_work_tree_algorithm_path(const std::shared_ptr<const misa_work_node> &t_node);
        ...
        friend std::ostream &operator<<(std::ostream &os, const misa_work_tree_algorithm_path &path) {
